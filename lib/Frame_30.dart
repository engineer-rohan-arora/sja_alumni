...
class IDGOI extends StatelessWidget {
  @override
                        ...
                        child: Container(
                            ...
                            child: Column(
                              children: <Widget>[
                                ...
                                Container(
                                  child: Text('ID Issued by Gov',style:TextStyle(fontSize: 16,decoration: TextDecoration.none,color: Colors.black,fontWeight: FontWeight.normal),),
                                ),
                              ],
                            )
                        ),
